 ...
 */
{
    ...
    class Shape {
        constructor(type, letterRect, options) {
            this.DOM = {};
            this.options = {
                shapeTypes: ['circle', 'rect', 'polygon', 'path'],
        ...
        configureShapeType() {
            ...
            if ( this.type === 'circle' ) {
                ...
                this.DOM.el.setAttribute('d', "M153.821,358.226L0,274.337v-46.463l153.821-83.414v54.574L46.636,250.523l107.185,53.431 C153.821,303.954,153.821,358.226,153.821,358.226z");
            }
        }
        onResize( letterRect ) {
            this.letterRect = letterRect;
